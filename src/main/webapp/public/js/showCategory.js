			...
			.datagrid(
					{
						...
						pageList : [ 5, 10, 15, 20 ],
						idField : 'c_id',// 指定id为标识字段，在删除，更新的时候有用，如果配置此字段，在翻页时，换页不会影响选中的项
						// 工具栏
						toolbar : [
								{
									iconCls : 'icon-add',
										...
										parent.$("#win_add").window(
														{
															...
															width : 450,
															height : 150,
															content : '<iframe src="category/saveView" frameborder="0" width="100%" height="100%"/>'
														});
									}
								},
								'-',
								        	...
								        	parent.$("#win_update").window(
													{
														...
														width : 450,
														height : 150,
														content : '<iframe src="category/updateView" frameborder="0" width="100%" height="100%"/>'
													});
								        }
						...
						columns : [ [
								...
								{
									field : 'c_account.a_id',
									title : '所属用户',
									width : 200,
									formatter : function(value, row, index) {
										if (row.c_account != null
												&& row.c_account.a_id != null) {
											return row.c_account.a_id; // 如果登录名不为空，显示登录名
										} else {
											return "此类别没有管理员";
										}
									}
