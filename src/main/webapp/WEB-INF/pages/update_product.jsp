...
<script type="text/javascript"
	src="${pageContext.request.contextPath }/public/js/update_product.js"></script>
</head>
<body>
	<form id="ff" title="更新商品" method="post" enctype="multipart/form-data">
		<div>
		...
		<div>
			<label>加入推荐:</label> 推荐:<input type="radio" name="p_commend"
				...
				name="p_commend" value="false" />
		</div>
		<div>
			<label>是否有效:</label> 上架:<input type="radio" name="p_open"
				checked="checked" value="true" /> 下架:<input type="radio" name="p_open"
				value="false" />
		...
		<div>
			<a id="submit" href="javascript:void(0)" class="easyui-linkbutton">更新</a>
		</div>
	</form>
</body>
</html>